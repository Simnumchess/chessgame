...
int minmax_ab_min(position_echecs &P, int profondeur, double alpha, double beta);//min à l'interieur du minmax
int minmax_ab_max(position_echecs &P, int profondeur, double alpha, double beta);//max à l'interieur du minmax
